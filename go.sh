...
kubectl wait --for=condition=available --timeout=900s deployments/$K8S_DEPLOYMENT_NAME > /dev/null 2>&1
...
kubectl wait --for=condition=ready --timeout=900s pods $K8S_POD_NAME > /dev/null 2>&1
